...
app.state.EMBEDDINGS_MODEL = SentenceTransformer(
    "dunzhang/stella_en_1.5B_v5",
    trust_remote_code=True,
    device="cpu"
)

app.state.QDRANT_CLIENTT = QdrantClient(
...
app.state.pipe = pipeline("text-classification", model="Hate-speech-CNERG/bert-base-uncased-hatexplain", return_all_scores=True)